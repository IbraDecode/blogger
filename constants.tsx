...
export const ARTICLES: Article[] = [
  ...
  {
    id: 51,
    title: 'Animasi CSS: Membuat Gerakan yang Menarik',
    summary: 'Ciptakan animasi web yang memukau dengan CSS, dari transisi sederhana hingga keyframe kompleks.',
    imageUrl: 'https://picsum.photos/seed/animation/800/600',
    content: placeholderContent,
  },
  {
    id: 52,
    title: 'Mengenal Svelte: Framework JavaScript Compiler',
    summary: 'Jelajahi Svelte, framework yang mengubah cara kita menulis komponen dengan pendekatan compiler yang unik.',
    imageUrl: 'https://picsum.photos/seed/svelte/800/600',
    content: placeholderContent,
  },
  {
    id: 53,
    title: 'Storage API: LocalStorage, SessionStorage, dan IndexedDB',
    summary: 'Pelajari cara menyimpan data di browser dengan berbagai mekanisme storage untuk pengalaman offline yang lebih baik.',
    imageUrl: 'https://picsum.photos/seed/storage/800/600',
    content: placeholderContent,
  },
  {
    id: 54,
    title: 'Pengenalan Machine Learning di Browser dengan TensorFlow.js',
    summary: 'Bangun model machine learning langsung di browser dengan TensorFlow.js, membawa AI lebih dekat ke frontend.',
    imageUrl: 'https://picsum.photos/seed/ml-browser/800/600',
    content: placeholderContent,
  },
  {
    id: 55,
    title: 'Framework Testing: Jest, Vitest, dan Cypress',
    summary: 'Bandingkan framework testing populer dan temukan yang terbaik untuk strategi testing Anda.',
    imageUrl: 'https://picsum.photos/seed/testing/800/600',
    content: placeholderContent,
  },
  {
    id: 56,
    title: 'Membangun Chatbot dengan JavaScript',
    summary: 'Ciptakan chatbot interaktif menggunakan JavaScript untuk meningkatkan engagement pengguna di website Anda.',
    imageUrl: 'https://picsum.photos/seed/chatbot/800/600',
    content: placeholderContent,
  },
  {
    id: 57,
    title: 'Pengenalan Web3 dan Smart Contracts',
    summary: 'Pahami dasar Web3, blockchain, dan bagaimana smart contracts mengubah web modern.',
    imageUrl: 'https://picsum.photos/seed/web3/800/600',
    content: placeholderContent,
  },
  {
    id: 58,
    title: 'Virtual Reality (VR) di Web dengan WebXR',
    summary: 'Eksplorasi API WebXR untuk membuat pengalaman VR dan AR yang imersif langsung di browser.',
    imageUrl: 'https://picsum.photos/seed/webxr/800/600',
    content: placeholderContent,
  },
  {
    id: 59,
    title: 'Audio Processing di Web: Web Audio API',
    summary: 'Buat aplikasi audio interaktif menggunakan Web Audio API, dari pemain musik hingga synthesizer.',
    imageUrl: 'https://picsum.photos/seed/webaudio/800/600',
    content: placeholderContent,
  },
  {
    id: 60,
    title: 'Developing Cross-Platform Apps dengan Electron',
    summary: 'Bangun aplikasi desktop menggunakan web technologies dengan Electron untuk Windows, macOS, dan Linux.',
    imageUrl: 'https://picsum.photos/seed/electron/800/600',
    content: placeholderContent,
  },
  {
    id: 61,
    title: 'Mobile Web dengan Progressive Enhancement',
    summary: 'Pelajari strategi progressive enhancement untuk membuat website yang bekerja di semua perangkat.',
    imageUrl: 'https://picsum.photos/seed/mobile-web/800/600',
    content: placeholderContent,
  },
  {
    id: 62,
    title: 'Geolocation API: Menggunakan Lokasi Pengguna',
    summary: 'Integrasikan fitur lokasi ke aplikasi web Anda dengan Geolocation API untuk pengalaman yang dipersonalisasi.',
    imageUrl: 'https://picsum.photos/seed/geolocation/800/600',
    content: placeholderContent,
  },
  {
    id: 63,
    title: 'Notification API: Push Notifikasi di Web',
    summary: 'Kirimkan notifikasi ke pengguna menggunakan Notification API dan Service Workers untuk engagement yang lebih baik.',
    imageUrl: 'https://picsum.photos/seed/notifications/800/600',
    content: placeholderContent,
  },
  {
    id: 64,
    title: 'Sensor Web: Mengakses Akselerometer dan Gyroscope',
    summary: 'Manfaatkan sensor perangkat untuk membuat interaksi unik dan gameplay yang inovatif di web.',
    imageUrl: 'https://picsum.photos/seed/sensors/800/600',
    content: placeholderContent,
  },
  {
    id: 65,
    title: 'Drag and Drop API untuk Interface Interaktif',
    summary: 'Buat interface yang intuitif dengan Drag and Drop API, dari file upload hingga reorganisasi elemen.',
    imageUrl: 'https://picsum.photos/seed/draganddrop/800/600',
    content: placeholderContent,
  },
  {
    id: 66,
    title: 'Fullstack dengan Ruby on Rails',
    summary: 'Temukan kemudahan dan produktivitas Ruby on Rails untuk pengembangan web fullstack yang cepat.',
    imageUrl: 'https://picsum.photos/seed/rails/800/600',
    content: placeholderContent,
  },
  {
    id: 67,
    title: 'Framework ASP.NET Core untuk Backend',
    summary: 'Pelajari ASP.NET Core, framework Microsoft yang powerful untuk membangun API dan aplikasi web.',
    imageUrl: 'https://picsum.photos/seed/aspnet/800/600',
    content: placeholderContent,
  },
  {
    id: 68,
    title: 'Database PostgreSQL: Relasional Canggih',
    summary: 'Kuasai PostgreSQL, database relasional open-source yang kuat dengan fitur-fitur lanjutan.',
    imageUrl: 'https://picsum.photos/seed/postgres/800/600',
    content: placeholderContent,
  },
  {
    id: 69,
    title: 'Framework Flutter untuk Mobile Web',
    summary: 'Bangun aplikasi mobile dan web dengan Flutter, framework dari Google untuk cross-platform development.',
    imageUrl: 'https://picsum.photos/seed/flutter/800/600',
    content: placeholderContent,
  },
  {
    id: 70,
    title: 'React Native untuk Aplikasi Mobile',
    summary: 'Kembangkan aplikasi mobile native menggunakan React dan JavaScript dengan React Native.',
    imageUrl: 'https://picsum.photos/seed/react-native/800/600',
    content: placeholderContent,
  },
  {
    id: 71,
    title: 'Tailwind CSS Plugins untuk Kustomisasi',
    summary: 'Perluas Tailwind CSS dengan plugins kustom untuk menciptakan design system yang unik.',
    imageUrl: 'https://picsum.photos/seed/tailwind-plugins/800/600',
    content: placeholderContent,
  },
  {
    id: 72,
    title: 'Storybook: Mengembangkan Komponen Terisolasi',
    summary: 'Gunakan Storybook untuk mengembangkan, menguji, dan mendokumentasikan komponen UI secara terisolasi.',
    imageUrl: 'https://picsum.photos/seed/storybook/800/600',
    content: placeholderContent,
  },
  {
    id: 73,
    title: 'WebGL untuk Grafis 3D di Browser',
    summary: 'Buat visualisasi 3D dan game menggunakan WebGL, API rendering grafis di browser.',
    imageUrl: 'https://picsum.photos/seed/webgl/800/600',
    content: placeholderContent,
  },
  {
    id: 74,
    title: 'Canvas API: Menggambar di Web',
    summary: 'Kuasai Canvas API untuk membuat grafis, animasi, dan game canvas di browser.',
    imageUrl: 'https://picsum.photos/seed/canvas/800/600',
    content: placeholderContent,
  },
  {
    id: 75,
    title: 'SVG: Grafis Vektor untuk Web',
    summary: 'Pelajari SVG untuk membuat grafis vektor scalable, animasi, dan ikon yang indah.',
    imageUrl: 'https://picsum.photos/seed/svg/800/600',
    content: placeholderContent,
  },
  {
    id: 76,
    title: 'Package Manager: npm, yarn, dan pnpm',
    summary: 'Bandingkan package manager untuk JavaScript dan pahami kelebihan serta kekurangan masing-masing.',
    imageUrl: 'https://picsum.photos/seed/packagemgr/800/600',
    content: placeholderContent,
  },
  {
    id: 77,
    title: 'Build Tools: Webpack, Vite, dan Rollup',
    summary: 'Pahami tools bundling berbeda dan kapan menggunakannya untuk optimasi build yang ideal.',
    imageUrl: 'https://picsum.photos/seed/buildtools/800/600',
    content: placeholderContent,
  },
  {
    id: 78,
    title: 'Linting dan Code Formatting dengan ESLint dan Prettier',
    summary: 'Tingkatkan kualitas kode dengan konfigurasi ESLint dan Prettier untuk konsistensi tim.',
    imageUrl: 'https://picsum.photos/seed/linting/800/600',
    content: placeholderContent,
  },
  {
    id: 79,
    title: 'Debugging Teknik Lanjutan di Browser',
    summary: 'Kuasai console API, DevTools, dan teknik debugging lanjutan untuk efisiensi maksimal.',
    imageUrl: 'https://picsum.photos/seed/debugging/800/600',
    content: placeholderContent,
  },
  {
    id: 80,
    title: 'Performance Profiling dan Optimization',
    summary: 'Gunakan Chrome DevTools untuk profiling dan identifikasi bottleneck performa di aplikasi Anda.',
    imageUrl: 'https://picsum.photos/seed/profiling/800/600',
    content: placeholderContent,
  },
  {
    id: 81,
    title: 'Headless CMS: Contentful dan Strapi',
    summary: 'Kuasai konsep Headless CMS dan mulai memisahkan content dari presentation layer.',
    imageUrl: 'https://picsum.photos/seed/cms/800/600',
    content: placeholderContent,
  },
  {
    id: 82,
    title: 'Static Site Generation dengan Hugo dan Jekyll',
    summary: 'Bangun situs statis yang cepat dan aman menggunakan static site generators.',
    imageUrl: 'https://picsum.photos/seed/ssg/800/600',
    content: placeholderContent,
  },
  {
    id: 83,
    title: 'E-commerce Platform Development',
    summary: 'Pahami arsitektur dan teknologi yang diperlukan untuk membangun platform e-commerce yang scalable.',
    imageUrl: 'https://picsum.photos/seed/ecommerce/800/600',
    content: placeholderContent,
  },
  {
    id: 84,
    title: 'Real-time Collaboration Tools (OT & CRDT)',
    summary: 'Pahami teknologi di balik aplikasi kolaborasi real-time seperti Google Docs.',
    imageUrl: 'https://picsum.photos/seed/collab/800/600',
    content: placeholderContent,
  },
  {
    id: 85,
    title: 'API Gateway dan Load Balancing',
    summary: 'Pelajari cara mengatur API Gateway dan load balancing untuk aplikasi yang scalable.',
    imageUrl: 'https://picsum.photos/seed/apigateway/800/600',
    content: placeholderContent,
  },
  {
    id: 86,
    title: 'Monitoring dan Logging untuk Aplikasi Web',
    summary: 'Implementasikan sistem monitoring dan logging untuk memahami kesehatan aplikasi Anda.',
    imageUrl: 'https://picsum.photos/seed/monitoring/800/600',
    content: placeholderContent,
  },
  {
    id: 87,
    title: 'GraphQL Subscriptions untuk Real-time Updates',
    summary: 'Implementasikan GraphQL Subscriptions untuk membuat koneksi real-time yang efisien.',
    imageUrl: 'https://picsum.photos/seed/gql-subs/800/600',
    content: placeholderContent,
  },
  {
    id: 88,
    title: 'Authentication Patterns: Session vs Token',
    summary: 'Bandingkan berbagai pola autentikasi dan pilih strategi yang tepat untuk keamanan aplikasi.',
    imageUrl: 'https://picsum.photos/seed/auth/800/600',
    content: placeholderContent,
  },
  {
    id: 89,
    title: 'Rate Limiting dan DDoS Protection',
    summary: 'Lindungi API Anda dari abuse dengan implementasi rate limiting dan DDoS protection.',
    imageUrl: 'https://picsum.photos/seed/ratelimit/800/600',
    content: placeholderContent,
  },
  {
    id: 90,
    title: 'Mobile App Development dengan Ionic',
    summary: 'Bangun hybrid mobile apps menggunakan Ionic, framework berbasis web technologies.',
    imageUrl: 'https://picsum.photos/seed/ionic/800/600',
    content: placeholderContent,
  },
  {
    id: 91,
    title: 'Desktop Apps dengan Tauri (Alternatif Electron)',
    summary: 'Kembangkan aplikasi desktop yang lebih ringan dengan Tauri dibanding Electron.',
    imageUrl: 'https://picsum.photos/seed/tauri/800/600',
    content: placeholderContent,
  },
  {
    id: 92,
    title: 'Micro Frontends Architecture',
    summary: 'Pelajari cara memecah frontend menjadi modul independen dengan arsitektur micro frontends.',
    imageUrl: 'https://picsum.photos/seed/microfrontend/800/600',
    content: placeholderContent,
  },
  {
    id: 93,
    title: 'Biometric Authentication di Web',
    summary: 'Implementasikan biometric authentication (fingerprint, face recognition) menggunakan WebAuthn.',
    imageUrl: 'https://picsum.photos/seed/biometric/800/600',
    content: placeholderContent,
  },
  {
    id: 94,
    title: 'AI-Powered Features dengan OpenAI API',
    summary: 'Integrasikan fitur AI ke aplikasi web Anda menggunakan OpenAI API dan LLMs.',
    imageUrl: 'https://picsum.photos/seed/openai/800/600',
    content: placeholderContent,
  },
  {
    id: 95,
    title: 'Analytics dan User Tracking Etis',
    summary: 'Implementasikan analytics tanpa melanggar privasi pengguna dengan pendekatan privacy-first.',
    imageUrl: 'https://picsum.photos/seed/analytics/800/600',
    content: placeholderContent,
  },
  {
    id: 96,
    title: 'Internasionalisasi (i18n) untuk Multi-bahasa',
    summary: 'Buat aplikasi yang mendukung berbagai bahasa dan lokalisasi dengan sistem i18n yang baik.',
  ...
  },
  {
    ...
    summary: 'Implementasikan dark mode yang indah dan accessible di aplikasi web Anda.',
    imageUrl: 'https://picsum.photos/seed/darkmode/800/600',
    content: placeholderContent,
  },
  {
    id: 98,
    title: 'Motion Design dan UX Animation',
    summary: 'Ciptakan pengalaman pengguna yang luar biasa dengan motion design dan micro-interactions.',
    imageUrl: 'https://picsum.photos/seed/motion/800/600',
    content: placeholderContent,
  },
  {
    id: 99,
    title: 'Design Systems dan Component Libraries',
    summary: 'Bangun design system yang konsisten dengan component library untuk skala organisasi.',
    imageUrl: 'https://picsum.photos/seed/designsys/800/600',
    content: placeholderContent,
  },
  {
    id: 100,
    title: 'API Documentation dengan OpenAPI dan Swagger',
    summary: 'Dokumentasikan API Anda dengan standar OpenAPI dan Swagger untuk developer experience.',
    imageUrl: 'https://picsum.photos/seed/apidoc/800/600',
    content: placeholderContent,
  },
  {
    id: 101,
    title: 'Blockchain untuk Supply Chain',
    summary: 'Pahami cara blockchain dapat digunakan untuk transparansi dan keamanan supply chain.',
    imageUrl: 'https://picsum.photos/seed/blockchain/800/600',
    content: placeholderContent,
  },
  {
    id: 102,
    title: 'IoT dan Web of Things',
    summary: 'Jelajahi Internet of Things dan cara mengintegrasikan device IoT dengan aplikasi web.',
    imageUrl: 'https://picsum.photos/seed/iot/800/600',
    content: placeholderContent,
  },
  {
    id: 103,
    title: 'Quantum Computing untuk Web Developer',
    summary: 'Pahami dasar quantum computing dan dampaknya pada keamanan web di masa depan.',
    imageUrl: 'https://picsum.photos/seed/quantum/800/600',
    content: placeholderContent,
  },
  {
    id: 104,
    title: 'Sustainability dalam Web Development',
    summary: 'Pelajari cara membuat website yang ramah lingkungan dan sustainable.',
    imageUrl: 'https://picsum.photos/seed/sustainability/800/600',
    content: placeholderContent,
  },
  {
    id: 105,
    title: 'Ethical AI dalam Aplikasi Web',
    summary: 'Pahami dampak etika menggunakan AI di aplikasi web dan tanggung jawab developer.',
    imageUrl: 'https://picsum.photos/seed/ethicalai/800/600',
    content: placeholderContent,
  },
];